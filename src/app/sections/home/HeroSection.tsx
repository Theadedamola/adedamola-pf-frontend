    ...
    <section className="min-h-[80vh] flex flex-col justify-center px-6 md:px-12 max-w-7xl mx-auto pt-24">
      ...
      >
        ...
        <h1 className="text-4xl 2xl:text-6xl font-normal leading-tight tracking-tight text-gray-900 mb-6">
          <span className="font-thaloria text-4xl md:text-6xl 2xl:text-7xl">
            Adedamola
          </span>{" "}
          crafts clarity from chaos — building intuitive digital experiences
          that feel less like software and more like second nature.
        </h1>
