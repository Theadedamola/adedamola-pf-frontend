...
export function ExperiencePill({
  ...
  const pillContent = (
    <span
      className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 mx-1 rounded-full bg-neutral-100 hover:bg-neutral-200/90 border border-neutral-200/90 text-neutral-800 font-medium text-[0.92em] align-baseline -translate-y-[1px] transition-all duration-150 cursor-pointer select-none group shadow-2xs ${className}`}
    >
      <span
